<?php include "db.php"; 
    ...
    $b_id = $_GET['id'];
    $query = mysqli_query($con,"select * from books where id='$b_id'");
...
<body>
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src="bookImages/<?= $book['cover'];?>">
      <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div class="flex mt-3">
          <span class="title-font font-medium text-2xl text-gray-900">Rs. <?= $book['discount_price'];?> <del><?= $book['mrp'];?></del></span>
...
<section>
    ...
    <div class="container px-5 py-24 mx-auto">
    <div class="flex">  
        <h2 class="text-3xl font-semibold">Related Books</h2>
    </div>       
          <div class="grid grid-cols-6 m-4 gap-4">

            <?php
            $cat_id = $book['category'];
            $query = "select * from books JOIN categories on books.category = categories.cat_id where books.category='$cat_id' AND id != '$b_id'";
